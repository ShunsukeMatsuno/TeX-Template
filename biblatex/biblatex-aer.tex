% https://github.com/dmsul/biblatex-aer/tree/master

% Use Chicago-style Bibliography and citation
\usepackage[authordate, backend=biber, uniquename=false, noibid, natbib=true, language=english]{biblatex-chicago}
